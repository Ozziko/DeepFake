...
#max_dataset_length=1000 # if positive: builds a dataset by sampling only max_dataset_length samples from all available data; requires user approval
...
loss_name='MSE'
#loss_name='BCE' # incomplete implementation!
    ...
    class autoencoder(nn.Module):
        def __init__(self):
            ...
            self.encoder = nn.Sequential(
                ...
                nn.Conv2d(16,8,8,stride=2,bias=False),
                nn.ReLU(True),
                nn.BatchNorm2d(8),
            ...
            self.decoder = nn.Sequential(
                ...
                nn.ConvTranspose2d(8,16,8,stride=2,bias=False),
                nn.ReLU(True),
                nn.BatchNorm2d(16),
